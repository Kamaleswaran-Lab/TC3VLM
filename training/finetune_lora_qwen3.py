#!/usr/bin/env python3
"""
Fine-tuning with LoRA (Qwen3-VL)

Fine-tunes Qwen3-VL vision-language models using LoRA.
Similar to finetune_lora.py but specifically for Qwen3-VL architecture.

Usage:
    python finetune_lora_qwen3.py --train-data train.jsonl --val-data val.jsonl --output-dir ./models
"""
...
# DEFAULT CONFIG
# ============================================================
DEFAULT_MODEL_NAME = "Qwen/Qwen3-VL-7B-Instruct"
DEFAULT_OUTPUT_DIR = "./models/lora_qwen3"
